...
from database.ia_filterdb import Media, get_file_details, unpack_new_file_id, P_FILES, get_search_results
...
BATCH_FILES = {}
BUTTONS = {}
MYPIC = ["https://telegra.ph/file/14f562bae60bb7bc5e773.jpg",
         "https://telegra.ph/file/32d583549d8c21018faad.jpg",
         "https://telegra.ph/file/dc7872a62f6f00a7f89f0.jpg",
         "https://telegra.ph/file/e8db8348cfc4b560c57b2.jpg",
         "https://telegra.ph/file/f7e30bdf21d62dd0bb806.jpg",
         "https://telegra.ph/file/5f64908c73d34b43230f0.jpg",
         "https://telegra.ph/file/2cdd8addfbc9403819e1a.jpg",
         "https://telegra.ph/file/5dae12bf9707cd7cae125.jpg",
         "https://telegra.ph/file/6ff9c8e510d4d6bfab4e1.jpg",
         "https://telegra.ph/file/8d139fcc6f5d7ec25ce9e.jpg",
         "https://telegra.ph/file/a848b95e3a545993a86a8.jpg",
         "https://telegra.ph/file/4a51389e0b621271d9ec0.jpg",
         "https://telegra.ph/file/29bdad91b1478a8a4ad46.jpg",
         "https://telegra.ph/file/229c9f513adb6f1cfacd3.jpg",
         "https://telegra.ph/file/e1b1abd65f1571f8151eb.jpg",
         "https://telegra.ph/file/e72993cb0109dc376dd85.jpg",
         "https://telegra.ph/file/d1f0782c257917a0577cb.jpg",
         "https://telegra.ph/file/da0883d9d1d2c165c4bb9.jpg",
         "https://telegra.ph/file/cc962068f1744949e92d9.jpg",
         "https://telegra.ph/file/ed308572a629b46694d48.jpg",
         "https://telegra.ph/file/e7c812e558bcf81e1a980.jpg",
        ]
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 𝚄𝚙𝚍𝚊𝚝𝚎𝚜', url='https://t.me/mandric_sprt')
            ],
            [
    ...
    if not files_:
        ...
        try:
            ...
            if CUSTOM_FILE_CAPTION:
                try:
                    f_caption=script.CAPTION.format(file_name= '' if title is None else title, file_size='' if size is None else size, file_caption='')
                except:
                    return
...
async def pmnexter(bot, query):
    ...
    if not search:
        ...
        return
    files, n_offset, total = await get_search_results(search, offset=offset, filter=True, max_results=6)
    try:
    ...
    if not files:
        return
    btn = []
    text = f"<b>Hey: {query.message.from_user.mention}\n\nYour Search Result is [{search}]</b>"
    for file in files:
        text += f"<i><b>\n\n<a href='https://t.me/{temp.U_NAME}?start=file_{file.file_id}'>⏩ [{get_size(file.file_size)}] {file.file_name}</a></b></i>"
    if 0 < offset <= 6:
        off_set = 0
    elif offset == 0:
        off_set = None
    ...
    if settings is not None:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    'TEXT-FILTER',
                    callback_data=f'setgs#text_ffilter#{settings["text_ffilter"]}#{grp_id}',
                ),
                InlineKeyboardButton(
                    '✔ Oɴ' if settings["text_ffilter"] else '✘ Oғғ',
                    callback_data=f'setgs#text_ffilter#{settings["text_ffilter"]}#{grp_id}',
                ),
            ],
            [
                InlineKeyboardButton(
                    'GRP-FILTER',
                    callback_data=f'setgs#grp_ffilter#{settings["grp_ffilter"]}#{grp_id}',
                ),
                InlineKeyboardButton(
                    '✔ Oɴ' if settings["grp_ffilter"] else '✘ Oғғ',
                    callback_data=f'setgs#grp_ffilter#{settings["grp_ffilter"]}#{grp_id}',
                ),
            ],
            [
